...
def partition(disk, fmt='gpt', options={}):
    ...
    if fmt == 'mbr':
        ...
        # PS2Ripper creates a data-only OPL device. It must not mark that data
        # partition active/bootable; doing so also weakens system-disk safety.
        mbr.partitions[0].bStatus = 0x00
